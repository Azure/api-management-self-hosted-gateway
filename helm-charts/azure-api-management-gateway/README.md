...
| `backup.enabled`                                   | If enabled will store a backup copy of the latests downloaded configuration on a storage volume                                                                                                                                                                                                 | `false`                                                        |
| `backup.existingPVCName`                                   | Use an existing Persistent Volume Claim instead of creating one. backup.createPVC needs to be false                                                                                                                                                                                                | `""`                                                        |
| `backup.createPVC`                                   | Create a Persistent Volume Claim with values specified in backup.PVC*                                                                                                                                                                                                     | `true`                                                        |
| `backup.PVC.storageClassName`                                   | storageClassName to be set on the Persistent Volume Claim. `null` means no storageClassName specified and will use the platform default, `""` means no storageClassName specified and none will be used.                                                                                                                                                                                                    | `null`                                                        |
| `backup.PVC.accessMode`                                   | accessMode for the Persistent Volume Claim  pod                                                                                                                                                                                                    | `ReadWriteMany`                                                        |
| `backup.PVC.size`                                   | Size of the Persistent Volume to be created                                                                                                                                                                                                    | `50Mi`                                                        |
