...
| `observability.opentelemetry.histogram.buckets`        | Define custom bucket sizes for all histograms in OpenTelemetry metrics. Format must be `,` separated.                                                                                                                                       | N/A                                              |
...
| `highAvailability.podTopologySpread.whenUnsatisfiable` | Indication how pods should be spread across nodes in case the requirement cannot be met. Learn more in the [Kubernetes docs](https://kubernetes.io/docs/concepts/workloads/pods/pod-topology-spread-constraints/)                           | `false`                                          |
