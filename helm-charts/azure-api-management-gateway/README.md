...
| `secret.useExisting.enabled`                           | Use an existing secret to provide the Authentication Key instead of creating one with the value specified above.                                                                                                                                            | `false`                                                            |
| `secret.useExisting.name`                              | Name of the existing secret to be used                                                                                                                                           |                                                             |
