...
| `secret.createSecret`                                  | Use an existing secret to provide the Authentication Key instead of creating one with the value specified above.                                                                                                                                            | `false`                                                            |
| `secret.secretName`                                    | Name of the existing secret to be used                                                                                                                                           |                                                             |
