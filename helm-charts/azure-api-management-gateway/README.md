...
| `observability.opentelemetry.systemMetrics.enabled` | Indication whether or not OpenTelemetry system metrics should be enabled. Learn more in [our documentation](https://learn.microsoft.com/en-us/azure/api-management/self-hosted-gateway-settings-reference#observabilityopentelemetrysystem-metricsenabled). | `false` |
