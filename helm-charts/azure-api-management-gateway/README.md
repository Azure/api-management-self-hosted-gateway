...
| `gateway.deployment.strategy.type`                     | Specifies the [strategy](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#strategy) to use for replacing old Pods by new ones. May be `Recreate` or `RollingUpdate`                                                              |                                                             |
| `gateway.deployment.strategy.rollingUpdate.maxUnavailable`               | An optional field that specifies the maximum number of Pods that can be unavailable during the update process. Learn more in the [Kubernetes docs](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#max-unavailable)      |                                                  |
| `gateway.deployment.strategy.rollingUpdate.maxSurge`                     | An optional field that specifies the maximum number of Pods that can be created over the desired number of Pods. Learn more in the [Kubernetes docs](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#max-surge)          |                                                  |
